...
if(isset($_POST['bot'])){
    $botid = $_POST['bot'];
}else { header("Location: botcontrol.php?request=failed"); }
if(isset($_POST['port'])){
    $port = $_POST['port'];
}else { header("Location: botcontrol.php?request=failed"); }
}else {
    ...
    $botid = $_GET['id'];
    if($botid == null){
       header("Location: botcontrol.php?request=failed"); 
    }
    if($port == null){
        header("Location: botcontrol.php?request=failed");
    }
...
$defaultchannel = str_replace("%2F","/", $defaultchannel);
$insert = mysqli_query($db,"UPDATE Botlist SET DefaultChannel= '".$defaultchannel."' WHERE BotID='".$botid."'");
 $z = mysqli_query($db, "SELECT BotID FROM Botlist WHERE BotID ='$botid'");
    while($row = mysqli_fetch_object($z)){
        $bot = $row->BotID;
    }    
if(!isset($bot)){
        header("Location: botcontrol.php?request=nobot");
    }
    ...
    if($port != $portbot){
        header("Location: botcontrol.php?request=noport");
    }
...
<body>
    ...
    <i class="fa fa-bars"></i>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="botcontrol.php">Bot Controller</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <div class="white-box">
                                ...
                                <form role="form" action="api.php?request=namechange&from=botadmin" method="post" class="input-form">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="white-box">
                                ...
                                <form role="form" action="api.php?request=shutdown&from=botadmin" method="post">
                                <input type="hidden" name="port" value='.$port.'>
                                <input type="hidden" name="id" value='.$botid.'>
                                    <div class="form-group">
                                    ';
                                ...
                                <input type="hidden" name="request" value="restartadmin">
                                ...
                                <div class="spacer"></div>
                                <form role="form" action="http://'.strtolower($system).'.tsradiobot.de/api/v2/apiv2.php" method="post">
                                <input type="hidden" name="request" value="killadmin">
                                <input type="hidden" name="Auth" value="radioonsucks">
                                <input type="hidden" name="botid" value='.$botid.'>
                                <input type="hidden" name="port" value='.$port.'>
                                <input type="hidden" name="system" value='.$system.'>
                                ...
                                <input type="hidden" name="default" value='.$defaultchannel.'>
                                    <div class="form-group">
                                    <button type="submit" class="btn" align="center">Kill</button>
                                    </div>
                                </form>
                                <div class="spacer"></div>
                                <form role="form" action="http://'.strtolower($system).'.tsradiobot.de/api/v2/apiv2.php" method="post">
                                <input type="hidden" name="request" value="startadmin">
                                <input type="hidden" name="Auth" value="radioonsucks">
                                <input type="hidden" name="botid" value='.$botid.'>
                                <input type="hidden" name="port" value='.$port.'>
                                <input type="hidden" name="system" value='.$system.'>
 ...
 ?>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="white-box">
                                <h1>Erweiterte Aktionen</h1>
                                <?php
                                echo '
                                <div class="row">
                                <form role="form" action="api.php?request=delete&from=botadmin" method="post">
                                <input type="hidden" name="id" value='.$botid.'>
                                <input type="hidden" name="port" value='.$port.'>
                                    <div class="form-group">';
                                 if($offline == 1){
                                   echo '<button type="submit" class="btn" align="center">Löschen</button>';
                                   }else {
                                   echo '<button type="submit" class="btn" align="center" disabled>Löschen</button>';
                                   }
                                   echo '
                                    </div>
                                </form>
                                <div class="spacer"></div>
                                <form role="form" action="api.php?request=reset&from=botadmin" method="post">
                                <input type="hidden" name="id" value='.$botid.'>
                                    <div class="form-group">
                                   <button type="submit" class="btn btn-3" style="background-color: #ff8800;" align="center">Resetten</button>
                                    </div>
                                    </form>
                                </div>';
                                ?>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            <div class="white-box">
                                ...
                                <h3>Streamlink</h3>
                                <form role="form" action="api.php?request=stream&from=botadmin" method="post">
                                <input type="hidden" name="port" value='.$port.'>
                                <input type="hidden" name="id" value='.$botid.'>
                                    <div class="form-group">
                                        ...
                                        <option>Mangoradio</option>
                                        <option>SloneFM</option>
                                        <option>Like2PlayFM</option>
                                        <option>RandyFM</option>
                                        <option>Crimeradio</option>
										<option>Homeradio</option>
										<option>Homerap</option>
                                        </select>
                                        ';
                                    if($offline == 1){
                                ...
                                <div style="margin-top: 10px;"></div>
                                <h3>Lautstärke</h3>
                                <form role="form" action="api.php?request=volume&from=botadmin" method="post">
                                 <input type="hidden" name="port" value='.$port.'>
                                 <input type="hidden" name="id" value='.$botid.'>
                                    <div class="form-group">
 ...
 ?>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            <div class="white-box">
                                ...
                                <form role="form" action="api.php?request=ServerIP&from=botadmin" method="post">
                                <input type="hidden" name="port" value='.$port.'>
                                <input type="hidden" name="botid" value='.$botid.'>
                                 <div class="form-group">
                                ...
                                <form role="form" action="api.php?request=DEFCH&from=botadmin" method="post">
                                <input type="hidden" name="port" value='.$port.'>
                                <input type="hidden" name="botid" value='.$botid.'>
                                    <div class="form-group">
 ...
 ?>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            <div class="white-box">
                                ...
                                <div style="margin-top: 10px;"></div>
                                <h3>Sonder UiD</h3>
                                <form role="form" action="api.php?request=UID&from=botadmin" method="post">
                                <input type="hidden" name="port" value='.$port.'>
                                <input type="hidden" name="botid" value='.$botid.'>
                                <div class="form-group">
                                    <label class="sr-only" for="form-text">Sonder UiD</label>
                                        <input style="border-color" type="text" name="uId" placeholder="Custom UiD" class="form-text-2 form-control" id="form-text" required>
                                         <br />
                                         </div>
                                         <button type="submit" class="btn" align="center" style="background-color: #1B9194;">Ändern</button>
                                         <div class="spacer">
                                ...
                                <div style="margin-top: 10px;"></div>
                                <h3>Direct API</h3>
                                <form role="form" action="api.php?request=console&from=botadmin" method="post">
                                <input type="hidden" name="port" value='.$port.'>
                                <input type="hidden" name="botid" value='.$botid.'>
                                    <div class="form-group">
                                    <label class="sr-only" for="form-text">Befehl</label>
                                        <input style="border-color" type="text" name="apicommand" placeholder="API Command" class="form-text-2 form-control" id="form-text" required>
                                         <br />
                                         </div>
                                         <button type="submit" class="btn" align="center" style="background-color: #1B9194;">Absenden</button>
                                         <div class="spacer">
                                         </div>
                                </form>';
 ?>
